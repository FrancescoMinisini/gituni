...
public:
    ...
    Solutore(double xmin, double xmax) : { if(xmax>xmin) {_xmax = xmax; _xmin = xmax} else {_xmin = xmax; _xmax = xmin} }
    Solutore(double xmin, double xmax, double prec) :  _prec(prec) {if(xmax>xmin) {_xmax = xmax; _xmin = xmax} else {_xmin = xmax; _xmax = xmin} }
    Solutore(double xmin, double xmax, double prec, unsigned int nmax) :  _prec(prec), _nmax(nmax) {if(xmax>xmin) {_xmax = xmax; _xmin = xmax} else {_xmin = xmax; _xmax = xmin} }
    virtual ~Solutore() {}
